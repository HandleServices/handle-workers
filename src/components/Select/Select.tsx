...
>(({ className, children, ...props }, ref) => {
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'box-border flex h-12 w-full items-center tracking-widest justify-between rounded-md bg-background outline-none border-[0.094rem] border-none ring-[0.094rem] ring-handle-blue-500 px-3 py-2 text-base disabled:cursor-not-allowed disabled:opacity-50 text-handle-blue-500 [&>svg]:data-[state=open]:rotate-180 data-[state=close]:delay-100 data-[placeholder]:border-handle-gray-700 data-[placeholder]:ring-[0.094rem] data-[placeholder]:ring-handle-gray-700 data-[placeholder]:text-handle-gray-700 [&:not(:focus)]:data-[state=closed]:ring-handle-gray-700 focus:text-handle-blue',
        className,
      )}
      {...props}
    >
