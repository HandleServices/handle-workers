...
>(({ className, children, ...props }, ref) => {
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'box-border flex h-12 w-full items-center tracking-widest justify-between rounded-md bg-background outline-none border-default-width border-handle-blue px-3 py-2 text-base disabled:cursor-not-allowed disabled:opacity-50 focus:text-handle-blue data-[state=open]:text-handle-blue [&>svg]:data-[state=open]:rotate-180 data-[state=close]:delay-100 data-[placeholder]:text-handle-gray-700 [&:not(:focus)]:data-[state=closed]:border-handle-gray-700',
        className,
      )}
      {...props}
    >
