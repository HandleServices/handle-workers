...
export default function AuthLayout({
  ...
  return (
    <section className="h-screen flex flex-row max-[585px]:flex-col">
      <section className="min-[585px]:min-h-full w-1/3 max-[585px]:w-full max-[585px]:h-[14%]  bg-handle-blue flex flex-col max-[585px]:flex-row items-center justify-center">
